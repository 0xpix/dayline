...
Focus is the only automatic Dayline overlay on the live Glyph face.
...
Dayline Settings keeps a simple 0–100% brightness UI.

The live Glyph Toy maps that percentage to the raw `IntArray` Matrix range used by Nothing's official example project, allowing raw output up to **2047** internally. Quiet-hours dimming is applied after this mapping.
