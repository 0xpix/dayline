# Dayline v0.18.6.beta — Validation Report

This report tracks the current **v0.18.6.beta / versionCode 1806** source. GitHub Actions remains the authoritative Android/Compose compile gate.

## Release checks

- Beta target: **0.18.6.beta / 1806**.
- `docs/releases/v0.18.6.beta.md` contains concise **Added / Changed / Fixed** updater notes.
- Beta/Play flavor separation remains intact; Play stays on the stable base version and does not package the Nothing SDK.
- Tagged builds must verify signed APK versionName/versionCode against tag `v0.18.6.beta`.
...
Before tagging `v0.18.6.beta`, GitHub Actions must pass:
