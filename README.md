...
[![Beta](https://img.shields.io/badge/status-beta-111111?style=flat-square)](https://github.com/0xpix/dayline/releases/tag/v0.18.6.beta)
[![Release](https://img.shields.io/badge/version-v0.18.6.beta-111111?style=flat-square)](https://github.com/0xpix/dayline/releases/tag/v0.18.6.beta)
...
[**Download the latest beta**](https://github.com/0xpix/dayline/releases/tag/v0.18.6.beta) · [Report a bug](https://github.com/0xpix/dayline/issues) · [Privacy](docs/privacy-policy.md)
...
| | |
|---|---|
| **Release** | `v0.18.6.beta` |
| **Android versionCode** | `1806` |
| **Status** | Public beta |
...
The current public release is **v0.18.6.beta**.

1. Open the [v0.18.6.beta release](https://github.com/0xpix/dayline/releases/tag/v0.18.6.beta).
2. Download `dayline-v0.18.6.beta.apk`.
