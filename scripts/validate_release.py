...
feature_checks = {
    ...
    "room legacy migration": "KEY_LEGACY_IMPORTED" in all_kotlin and "planLegacyRoomMigration" in all_kotlin and "itemsToLegacyJson" in all_kotlin and "spacesToLegacyJson" in all_kotlin,
