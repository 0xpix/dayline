...
required = [
    ...
    "app/src/main/java/com/pix/dayline/data/CalendarProviderTimePolicy.kt",
    "app/src/test/java/com/pix/dayline/data/CalendarProviderTimePolicyTest.kt",
    "app/src/main/java/com/pix/dayline/data/CalendarSyncBaselineStore.kt",
    "app/src/test/java/com/pix/dayline/model/DaylineItemDurationTest.kt",
    "app/src/test/java/com/pix/dayline/data/QuickAddDraftTest.kt",
    "app/src/test/java/com/pix/dayline/data/QuickAddParserTest.kt",
    "app/src/test/java/com/pix/dayline/data/QuickAddPreviewTest.kt",
    "app/src/main/java/com/pix/dayline/data/QuickAddPreview.kt",
    "app/src/test/java/com/pix/dayline/data/room/RoomEntityMappingTest.kt",
    "app/src/test/java/com/pix/dayline/data/room/RoomMigrationPlanTest.kt",
    "app/src/main/java/com/pix/dayline/data/room/RoomMigrationPlan.kt",
...
feature_checks = {
    ...
    "recurring edit prompt": "Edit recurring event" in all_kotlin and "This event" in all_kotlin and "This and following" in all_kotlin and "All events" in all_kotlin and "PendingRecurringDelete" in all_kotlin and "SeriesEditResult" in all_kotlin and "editForGestureScope" in all_kotlin,
    "drag resize": "onResize" in all_kotlin and "shiftStart" in all_kotlin and "shiftEnd" in all_kotlin and "withStartPreservingDuration" in all_kotlin and "withStartEdge" in all_kotlin and "withEndEdge" in all_kotlin and "detectDragGestures" in all_kotlin,
    ...
    "undo": '"UNDO"' in all_kotlin and "Undo last change" in all_kotlin and "undoHistory" in all_kotlin,
    ...
    "widget direct actions": "ToggleWidgetTaskAction" in all_kotlin and "ACTION_QUICK_ADD" in all_kotlin and "+ ADD" in all_kotlin,
    ...
    "calendar duration preservation": "CalendarProviderTimePolicy" in all_kotlin and "reconciledEndTime" in all_kotlin and "durationMillis" in all_kotlin,
    "calendar conflict baseline": "CalendarSyncBaselineStore" in all_kotlin and "syncFingerprint" in all_kotlin and "CALENDAR CONFLICTS" in all_kotlin,
    ...
    "glyph app states": "REMINDER_SOON" in all_kotlin and "CONFLICT" in all_kotlin and "DAY_OPEN" in all_kotlin and "Brief app states" in all_kotlin,
